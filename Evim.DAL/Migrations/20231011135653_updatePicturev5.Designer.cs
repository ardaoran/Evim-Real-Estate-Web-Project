...
namespace Evim.DAL.Migrations
{
    ...
    [Migration("20231011135653_updatePicturev5")]
    partial class updatePicturev5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Evim.DAL.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            LastLoginIP = "",
                            LastLongDate = new DateTime(2023, 10, 11, 16, 56, 53, 15, DateTimeKind.Local).AddTicks(5685),
