...
namespace Evim.DAL.Migrations
{
    ...
    [Migration("20231015115154_slideupdatev5")]
    partial class slideupdatev5
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Evim.DAL.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            LastLoginIP = "",
                            LastLongDate = new DateTime(2023, 10, 15, 14, 51, 53, 997, DateTimeKind.Local).AddTicks(4330),
            ...
            modelBuilder.Entity("Evim.DAL.Entities.MulkEkle", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Evim.DAL.Entities.Slide", b =>
                {
                    ...
                    b.Property<string>("SloganBuyuk2")
                        .HasMaxLength(50)
                        .HasColumnType("Varchar(100)");
            ...
            modelBuilder.Entity("Evim.DAL.Entities.SlidePicture", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Evim.DAL.Entities.SlidePicture", b =>
                {
                    b.HasOne("Evim.DAL.Entities.Slide", "Slide")
                        .WithMany("SlidePictures")
