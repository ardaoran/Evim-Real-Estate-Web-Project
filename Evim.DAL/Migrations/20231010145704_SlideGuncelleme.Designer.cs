...
namespace Evim.DAL.Migrations
{
    ...
    [Migration("20231010145704_SlideGuncelleme")]
    partial class SlideGuncelleme
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Evim.DAL.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            LastLoginIP = "",
                            LastLongDate = new DateTime(2023, 10, 10, 17, 57, 4, 603, DateTimeKind.Local).AddTicks(9669),
