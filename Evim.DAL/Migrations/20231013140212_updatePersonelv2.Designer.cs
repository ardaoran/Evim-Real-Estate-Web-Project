...
namespace Evim.DAL.Migrations
{
    ...
    [Migration("20231013140212_updatePersonelv2")]
    partial class updatePersonelv2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Evim.DAL.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            LastLoginIP = "",
                            LastLongDate = new DateTime(2023, 10, 13, 17, 2, 12, 269, DateTimeKind.Local).AddTicks(1252),
