...
namespace Evim.DAL.Migrations
{
    ...
    [Migration("20231013140426_updatePersonelv3")]
    partial class updatePersonelv3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Evim.DAL.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            LastLoginIP = "",
                            LastLongDate = new DateTime(2023, 10, 13, 17, 4, 26, 111, DateTimeKind.Local).AddTicks(9132),
