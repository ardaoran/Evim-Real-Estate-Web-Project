...
namespace Evim.DAL.Migrations
{
    ...
    [Migration("20231011130050_MulkEntityChangev1")]
    partial class MulkEntityChangev1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Evim.DAL.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            LastLoginIP = "",
                            LastLongDate = new DateTime(2023, 10, 11, 16, 0, 50, 624, DateTimeKind.Local).AddTicks(6253),
