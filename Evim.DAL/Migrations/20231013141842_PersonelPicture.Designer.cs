...
namespace Evim.DAL.Migrations
{
    ...
    [Migration("20231013141842_PersonelPicture")]
    partial class PersonelPicture
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Evim.DAL.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            LastLoginIP = "",
                            LastLongDate = new DateTime(2023, 10, 13, 17, 18, 41, 898, DateTimeKind.Local).AddTicks(617),
